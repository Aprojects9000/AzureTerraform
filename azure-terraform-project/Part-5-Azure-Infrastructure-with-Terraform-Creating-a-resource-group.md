...
In this part we're going to work through the process of creating a resource group. 
...
1. Click on the create button of the Resource group's sub menu.  
    ![Image 5.1.1](images/5.1.1-creating-resource-group-manually.png)
2. Choose your subscription, name your resource group, and choose a region. Then skip the Tags menu by clicking on Review + create.
    ![Image 5.1.2](images/5.1.2-creating-resource-group-manually.png)
3. Create your resource group.  
    ![Image 5.1.3](images/5.1.3-creating-resource-group-manually.png)
4. Congrats! Now delete your resource group. This is done by clicking on the resource group menu on the left hand side as is seen in step 1.   
    ![Image 5.1.4.1](images/5.1.4.1-creating-resource-group-manually.png)  
    ![Image 5.1.4.2](images/5.1.4.2-creating-resource-group-manually.png)
...
2. The first important step in the definition of our first configuration file is authentication. Terraform needs the right credentials to get the same privileges for creating resources as your Azure account has. This should be done without giving all your Azure account details to Terraform, since that would increase the chance of a security breach. A separate set of credentials needs to be created for Terraform so that it can be authenticated and get the necessary privileges on the Azure platform. For this, we will create an Application Object in Azure Active Directory. It is similar to a user identity in that it creates a digital identity within Microsoft Entra ID. 
    ...
    **Creating an Application Object:**
    ...
    ![Image 5.2.1](images/5.2.1-creating-application-object.png)
    2. Open the "Manage" (1) option and click on "App registration" (2).  
    ![Image 5.2.2](images/5.2.2-creating-application-object.png)
    3. Click on "New registration."  
    ![Image 5.2.3](images/5.2.3-creating-application-object.png)
    4. Create a display name. Leave the rest as it is, and click on register.  
    ![Image 5.2.4.1](images/5.2.4-creating-application-object.png)  
...
3. **Creating a resource group with Terraform**  
    ...
    ![Image 5.3.1](images/5.3.1-making-the-configuration-file.png)
    ...
    ![Image 5.3.2](images/5.3.2-making-the-configuration-file.png)
        ...
        **Client ID:**  
        ...
        ![Image 5.3.3](images/5.3.3-making-the-configuration-file.png)

        Here you'll find your application (client) ID. Hover over it and click on copy to clipboard to copy the ID.  
        ![Image 5.3.4](images/5.3.4-making-the-configuration-file.png)
        ...
        **Client secret:**
        ...
        ![Image 5.3.5](images/5.3.5-making-the-configuration-file.png)
        ...
        ![Image 5.3.6](images/5.3.6-making-the-configuration-file.png)
        ...
        ![Image 5.3.7](images/5.3.7-making-the-configuration-file.png) 

        **Subscription ID:**

        Type 'subscriptions' into your search bar (1) in the portal, and click on subscriptions (2):  
        ![Image 5.3.8](images/5.3.8-making-the-configuration-file.png)

        From there you can click on your subscription:  
        ![Image 5.3.9](images/5.3.9-making-the-configuration-file.png)

        And here you can copy the subscription ID to the clipboard.  
        ![Image 5.3.10](images/5.3.10-making-the-configuration-file.png)
    ...
    3. Setting permissions for the application object. 
        ...
        ![Image 5.4.1](images/5.4.1-setting-permissions-RBAC.png)

        2. From there you can click on add, and add role assignment.  
        ![Image 5.4.2](images/5.4.2-setting-permissions-RBAC.png)


        3. Now you select Priviliged administrator roles (1), then Contributor (2), and then next (3).  
        ![Image 5.4.3](images/5.4.3-setting-permissions-RBAC.png)


        4. From here you make sure that 'User, group, or service principal' is selected (1), you click on 'select members' (2), you type the application name into the searchbar (3), then select the application (4-5), and then click on review + assign (6). Click on the review + assign button twice.  
        ![Image 5.4.4](images/5.4.4-setting-permissions-RBAC.png)
    ...
    5. Deploying the Terraform file
        ...
        ![Image 5.5.1](images/5.5.1-deploying-the-terraform-file.png)  

        1. Create a new terminal:  

        ![Image 5.5.2](images/5.5.2-deploying-the-terraform-file.png) 

        2. Initialise the working directory by using the ```terraform init``` command: 

        ![Image 5.5.3](images/5.5.3-deploying-the-terraform-file.png)  
        ...
        ![Image 5.5.4](images/5.5.4-deploying-the-terraform-file.png) 
        ...
        ![Image 5.5.5](images/5.5.5-deploying-the-terraform-file.png)  
        ...
        ![Image 5.5.6](images/5.5.6-deploying-the-terraform-file.png) 

**Final note:** Don't forget to save your main.tf file for future use.
